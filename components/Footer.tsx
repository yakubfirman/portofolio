...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden border-t border-red-900/20 bg-[#060606]">
      ...
      <div className="pointer-events-none absolute -left-40 -top-24 h-80 w-80 rounded-full bg-red-950/25 blur-[120px]" />
        ...
        <Reveal>
          <div className="border-b border-red-900/15 py-12 sm:py-16">
            <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
              {/* Brand text */}
              <div>
                <p className="mb-2 font-mono text-[11px] font-semibold uppercase tracking-widest text-red-700/60">
                  Available for Work
                </p>
                <h2 className="text-3xl font-black leading-tight tracking-tighter text-white sm:text-4xl lg:text-5xl">
              ...
              >
                <FontAwesomeIcon icon={faEnvelope} className="h-4 w-4 text-red-400" aria-hidden="true" />
                Kirim Email
                <FontAwesomeIcon
                  icon={faArrowRight}
          ...
          <div className="grid grid-cols-2 gap-10 py-10 sm:grid-cols-3">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <p className="text-xs leading-relaxed text-gray-700">
                Full Stack Web Developer<br />& SEO Specialist<br />Surakarta, Jawa Tengah
              </p>
            </div>

            {/* Nav */}
            <div>
              <p className="mb-4 text-[10px] font-bold uppercase tracking-widest text-gray-600">
                Navigasi
              </p>
              <nav className="flex flex-col gap-2">
                {NAV_LINKS.map((link) => (
                  <a
                    key={link.href}
                    href={link.href}
                    className="group flex items-center gap-1.5 text-sm text-gray-600 transition-colors hover:text-red-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500/70 rounded-xs"
                  >
              ...
              <div className="flex flex-col gap-2">
                {SOCIALS.map(({ label, href, icon }) => (
                  <a
                    ...
                    aria-label={label}
                    className="group flex items-center gap-2.5 text-sm text-gray-600 transition-colors hover:text-red-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500/70 rounded-xs"
                  >
          ...
          <div className="flex flex-col items-center justify-between gap-3 border-t border-red-900/10 py-6 sm:flex-row">
            ...
            <div className="flex items-center gap-4">
              <span className="text-xs text-gray-700">
                Built with{" "}
                <span className="text-gray-600">Next.js · Tailwind CSS</span>
              </span>
              <a
                href="#hero"
