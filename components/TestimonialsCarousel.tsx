      ...
      <div className="relative mb-8 mx-auto">
        {displayItems.map((testimonial) => (
          <Reveal key={`${current}`} delay={0}>
            <div className="group/card max-w-3xl mx-auto flex flex-col overflow-hidden rounded-xs border border-red-900/20 bg-[#0d0404] transition-all duration-300 hover:-translate-y-1 hover:border-red-800/40 hover:shadow-xl hover:shadow-red-950/30 animate-in fade-in p-6 sm:p-8">
              {/* Glow accent */}
